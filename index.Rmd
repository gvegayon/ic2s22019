...
date: "IC$^2$S$^2$ 2019, Amsterdam \\linebreak[4]June 20, 2019"
...
## Revising model degeneracy and existance of MLE
...
-  Not in the interior: \uscred{We are in trouble}, MLE may not exist 
...
```{r fit-fivenets-print, echo=TRUE, cache=FALSE}
summary(model1) # 
```
...
\begin{figure}
\centering
\includegraphics[width=.65\linewidth]{fig/bias-02-various-sizes-4-5-ttriad.pdf}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=.65\linewidth]{fig/power-02-various-sizes-4-5-ttriad.pdf}
\end{figure} \pause{}
...
\begin{figure}
\centering
\includegraphics[width=.65\linewidth]{fig/bias-relative-02-various-sizes-4-5-ttriad.pdf}
\end{figure} 
...
\begin{figure}
\centering
\includegraphics[width=.65\linewidth]{fig/bias-elapsed-02-various-sizes-4-5-ttriad.pdf}
\end{figure} 
...
- Three scenarios:\pause
    ...
    c. Uknown (hypothesized) mediated association (an unknown confounder)
